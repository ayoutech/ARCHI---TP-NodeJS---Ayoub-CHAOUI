...
// --- Ajout Socket.io et exposer io à l'app ---
const { Server } = require('socket.io');
const io = new Server(server, { cors: { origin: "*" } });
app.set('io', io);

// Si setupSocketServer fait autre chose, tu peux le garder ici :
...
require('./src/routes/refreshToken.route')(app);  // Token refresh est souvent public
...
require('./src/routes/createMonument.route')(app, io); // Passage io pour notifications
...
server.listen(3001, () =>
    console.log('Server & Socket.io running at http://localhost:3001')
);
